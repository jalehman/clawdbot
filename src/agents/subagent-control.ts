...
import { loadSessionStore, patchSessionEntryWithRowOptions } from "../config/sessions/store.js";
...
type PatchSessionEntry = typeof patchSessionEntryWithRowOptions;
...
const defaultSubagentControlDeps = {
  callGateway,
  patchSessionEntry: patchSessionEntryWithRowOptions,
};
